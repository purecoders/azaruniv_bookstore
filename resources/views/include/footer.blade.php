    ...
    <div class="p-5 rtl">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <ul>
                    <li><a href="{{route('site-home')}}">صفحه اصلی</a>
                    </li>

                    <li><a href="http://www.azaruniv.ac.ir/?PageID=6" target="_blank">درباره ما</a>
                    </li>
                    <li><a href="http://www.azaruniv.ac.ir/?PageID=6" target="_blank">تماس با ما</a>
                    </li>
                </ul>
